...
public class TBgcdAdapter extends BaseAdapter implements View.OnClickListener {
    List<CheckInfoEntiy> checkInfoEntiys = new ArrayList<>();
    private ContentListActivity mContext;
    private InnerItemOnclickListener mListener;

    public TBgcdAdapter(ContentListActivity context, List<CheckInfoEntiy> list) {
        mContext = context;
